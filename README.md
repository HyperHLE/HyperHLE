...
**SuperHLE** is an independent fork of the touchHLE project. To avoid any confusion with the upstream repository, please review the key characteristics and context of this fork below.
...
To ensure complete transparency and maintain a clean open-source ecosystem, the SuperHLE team wishes to state the following:
